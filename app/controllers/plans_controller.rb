class PlansController < ApplicationController
  ...
  private
    ...
    def plan_params
      params.require(:plan).permit(:number, :name, :this_amount, :year_amount, :start_date, :end_date, :management_fee, :investment_manager, :scale, :department_id, :rate, :fee, :notes, :plan_type, :annual, :risk, :parter, :charge_type, :charge_amount, cooperations_attributes: [:id, :user_id, :ratio, :_destroy])
    end
end
