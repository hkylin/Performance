...
RSpec.describe Department, type: :model do
  ...
  it 'should test count_scale2' do
    ...
    project2=Project.create(name: '2号项目', number: :QS713003, plan: plan1, user: wjf, department: jh1,parter: :民生银行, risk: :正常, start_date: '2012-11-8', end_date: '2016-4-15',scale: 800000000, channel_cost: 0, rate: 0.004, annual: 360)
    Cooperation.create(user: usl, ratio: 0.2, cooperationable: project2, co_type: Cooperation::CO_TYPE[0])
    Cooperation.create(user: wjf, ratio: 0.8, cooperationable: project2, co_type: Cooperation::CO_TYPE[1])
    ...
    #     puts m.name
    # end
    puts jh1.count_inproject_outuser_income(Date.first_quarter)
    ...
    # puts jh2.count_inproject_outuser_income(Date.one_year)
    # puts jh2.count_income2
    # puts "-------jh3-------"
    # puts jh3.count_scale2
